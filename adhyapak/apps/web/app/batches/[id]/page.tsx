import { BATCHES } from '@adhyapak/core';
 ...
 * empty array fails the build outright — and the bundled batches are gone, so it
 ...
 *
 * This is also why batches that exist only in Postgres get no prerendered
...
export function generateStaticParams() {
  const ids = BATCHES.map((b) => ({ id: b.id }));
